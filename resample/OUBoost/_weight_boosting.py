...
##############My AdaBoostClassifier################################################
class AdaBoostClassifierMe(ClassifierMixin, BaseWeightBoosting):
    ...
    def _boost(self, iboost, X, y, sample_weight, random_state,X_org,y_org,sample_weight_org):
        ...
        estimator_error : float
            ...
            If None then boosting has terminated early.
        """
       # print("boost AdaBoostClassifier")
    ...
    def _boost_real(self, iboost, X, y, sample_weight, random_state,X_org,y_org,sample_weight_org):
     ...
     #   print(sample_weight.shape)
       # print(X_org.shape)
        ...
        # Error fraction
       # print(incorrect.shape,sample_weight_org.shape)
    ...
    def predict(self, X):
        ...
        """
       # print("predict: Predict classes for X.")
        X = self._check_X(X)
       #$ print("shape",X.shape)
